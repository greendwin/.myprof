...
~/.bash_it/install.sh -s		# use silent mode to allow installation in vagrant provision
...
# TODO: rename .tmux.confg and .vimrc to tmux and vimrc so they are no longer hidden in the repo
